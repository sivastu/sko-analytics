    ...
    <div>
      ...
      <div style={{ backgroundColor: "#ECF1F4", height: '100vh' }} >
        ...
        <div className="d-flex " style={{}} >
          ...
          <div className=" " style={{ paddingLeft :  50 , paddingRight :  50 , width : '100%' }} >
              <div style={{ border : '1px solid #9F9F9F' , height : '100%'   }} >
                ...
                <div className="d-flex" style={{    padding : 20 , height : 60 }} >
                  ...
                  <div style={{ width : '20%' }}>
                    <p style={{ color : '#1A1A1B' , fontWeight : '400' }} ><Select 
                  isMulti
